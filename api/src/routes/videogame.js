...
const {videogameDetail, createVideogame} = require("../utils/videogame");
    ...
    router.post("/",(req,res)=>{
        ...
        if(!name || !description || !released || !rating || !genres || !platforms) return res.status(400).send("Uno o más de los argumentos necesarios para crear la entrada del videojuego no han sido provistos");
